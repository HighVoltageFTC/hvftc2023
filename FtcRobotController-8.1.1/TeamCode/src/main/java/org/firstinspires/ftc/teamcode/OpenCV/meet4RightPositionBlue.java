...
@Autonomous
public class meet4RightPositionBlue extends LinearOpMode {
...
//        backRightMotor.setDirection(DcMotorSimple.Direction.REVERSE);
    ...
    public void position() {
        ...
        if(xPosition > -24) {
            ...
            telemetry.update();
            forward(0.4,(int) (xPosition + 24)*50 );
            ...
            telemetry.addData("Ticks to move left: %d", (int) ( 30-yPosition)*50 );
            telemetry.update();
            left(0.4,(int) (30-yPosition)*50 );
        }
    }
