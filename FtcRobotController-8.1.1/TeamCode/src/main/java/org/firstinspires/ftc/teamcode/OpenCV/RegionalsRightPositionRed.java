...
@Autonomous
public class RegionalsRightPositionRed extends LinearOpMode {
...
//        backward(0.4, 100);
    ...
    public void position() {
        ...
        if(xPosition > 40) {
            telemetry.addData("Ticks to move backward: %d", (int) (xPosition-40)*50 );
            telemetry.update();
            backward(0.4,(int) (xPosition-40)*50 );
        } else if(xPosition < 40) {
            telemetry.addData("Ticks to move backward: %d", (int) (xPosition-40)*50 );
            telemetry.update();
            forward(0.4,(int) (40-xPosition)*50 );
        } if(yPosition > -39) {
            telemetry.addData("Ticks to move right: %d", (int) (yPosition+ 39)*50 );
            telemetry.update();
            right(0.4,(int) (yPosition + 39)*50 );
        } else if(yPosition < -39) {
            telemetry.addData("Ticks to move left: %d", (int) (yPosition + 39)*-50 );
            telemetry.update();
            left(0.4,(int) (yPosition + 39)*-50 );
        }
